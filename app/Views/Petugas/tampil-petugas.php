...
<?php foreach($ListPetugas as $key => $row): ?>
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        <a href="/petugas/edit/<?= $row['id_petugas']?>" class="btn btn-secondary"><i class="fa-solid fa-user-pen"> Edit</i></a>
                                        <a onclick="return confirm('Anda Yakin Ingin Menghapus Ini')" href="/petugas/hapus/<?=$row['id_petugas']?>" class="btn btn-danger"><i class="fas fa-trash-alt"> Hapus</i></a>
                                    </div>
                                </td>
                            </tr>
                            <?php endforeach;?>
