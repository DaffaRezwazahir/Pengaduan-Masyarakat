...
<?php foreach($ListMasyarakat as $key => $row): ?>
                            <tr>
                                ...
                                <td class="text-center">
                                    <div class="btn-group">
                                        <a href="/masyarakat/edit/<?= $row['nik']?>" class="btn btn-secondary"><i class="fa-solid fa-user-pen"> Edit </i></a>
                                        <a onclick="return confirm('Anda Yakin Ingin Menghapus Ini')" href="/masyarakat/hapus/<?=$row['nik']?>" class="btn btn-danger"><i class="fas fa-trash-alt"> Hapus </i></a>
                                    </div>
                                </td>
                            </tr>
                            <?php endforeach;?>
